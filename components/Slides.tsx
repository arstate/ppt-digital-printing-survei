...
const SlideWrapper: React.FC<{ title: string; children: React.ReactNode; subtitle?: string; }> = ({ title, subtitle, children }) => (
  <div className="w-full h-full bg-white/30 backdrop-blur-xl border border-white/40 rounded-3xl shadow-2xl p-16 md:p-20 text-slate-800 flex flex-col overflow-hidden print:shadow-none">
